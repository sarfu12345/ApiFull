package com.omrbranch.removeProduct;
...
import com.omrbranch.deletecart.DeleteCart_Output_Pojo;
import com.omrbranch.deletecart.Deletecart_Input_Pojo;
...
public class RemoveProductFromCart extends BaseClass {
	...
	public void deleteCartitem() {
		...
		addHeaders(headers);
		Deletecart_Input_Pojo deletecart_Input_Pojo = new Deletecart_Input_Pojo(getItemIdtext);
			addPayload(deletecart_Input_Pojo);
			Response response = getResponse("DELETE", "https://omrbranch.com/api/deleteCartItems");
			DeleteCart_Output_Pojo deletecart_Output_Pojo = response.as(DeleteCart_Output_Pojo.class);
			String message = deletecart_Output_Pojo.getMessage();
	...
	public void getCartItems() {
		...
		for (com.omrbranch.UserGetCartItems.Datum datum : data) {
			 getItemId = datum.getId();
			System.out.println("print itemId:"+getItemId);
			 getItemIdtext = String.valueOf(getItemId);
		}
	...
	public static void main(String[] args) {
		...
		removeProductFromCart.getcategoryList();
		removeProductFromCart.getProductList();
		removeProductFromCart.addToCart();
		removeProductFromCart.getCartItems();
		removeProductFromCart.deleteCartitem();
