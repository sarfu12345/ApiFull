package com.omrbranch.favourite;
...
public class AddFavourite extends BaseClass {
	String logToken;
	String category_id;
	String logtoken;
	String variantText;
	...
	public void addUserFavourite() {
		...
		addHeaders(headers);
		manageUserFavourite_Input_pojo manageUserFavourite_Input_pojo = new manageUserFavourite_Input_pojo(productIdText, variantText);
	...
	public static void main(String[] args) {
		...
		addFavourite.login();
		addFavourite.categoryList();
		addFavourite.getProductList();
		addFavourite.addUserFavourite();
		addFavourite.getUserfavourites();
